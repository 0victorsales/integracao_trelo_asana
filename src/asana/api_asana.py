...
token = os.getenv('TOKEN_ASANA')
configuracoes = asana.Configuration()
configuracoes.access_token = token
api_client = asana.ApiClient(configuracoes)
api_projects = asana.ProjectsApi(api_client)
api_tasks = asana.TasksApi(api_client)
...
def criar_project(nome_projeto,id_workspace):
    ...
    try:
        response = api_projects.create_project(body, opts)
        return response
...
def get_project(project_gid):
    ...
    try:
        response = api_projects.get_project(project_gid, opts)
        return response
    except ApiException as e:
...
def delete_project(project_gid):
    ...
    try:
        # Delete a project
        api_response = api_projects.delete_project(project_gid)
        pprint(api_response)
    except ApiException as e:
...
def get_task(task_gid):
    ...
    try:
        ...
        response = api_tasks.get_task(task_gid, opts)
        return response
    except ApiException as e:
...
def criar_task(project_id,nome_task, descricao_task,prazo_task,workspace_id):
    ...
    try:
        response = api_tasks.create_task(body, opts)
        return response
    except ApiException as e:
...
def delete_task(task_gid):
    try:
        response = api_tasks.delete_task(task_gid)
        return response
    except ApiException as e:
